...
public class RobotControllerAgent : Agent
{
   ...
   private void UpdateNearestComponent()
   {
      ...
      if(!inFrontOfComponent)
         // nearestComponent.transform.position = nearestComponent.transform.position + new Vector3(Random.Range(-0.08f,0.01633f),Random.Range(0.0f,0.186f), Random.Range(0.00f,0.012f));
         nearestComponent.transform.position = transform.position + new Vector3(Random.Range(0.1f,0.2f),Random.Range(0.033f,0.1f), Random.Range(0.1f,0.2f));
      else
      {
         // nearestComponent.transform.position = endEffector.transform.TransformPoint(Vector3.zero) + new Vector3(Random.Range(0.01f,0.015f),Random.Range(0.01f,0.15f), Random.Range(0.0f,0.01f));
         nearestComponent.transform.position = endEffector.transform.TransformPoint(Vector3.zero) + new Vector3(Random.Range(0.0033f,0.05f),Random.Range(0.0033f,0.05f), Random.Range(0.0033f,0.05f));
         // Debug.LogWarning(endEffector.transform.TransformPoint(Vector3.zero));
      }
